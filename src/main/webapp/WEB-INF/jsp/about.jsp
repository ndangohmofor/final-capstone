...
<img class="center-block AboutImg" src="${pageContext.request.contextPath}/img/Logo.png" alt="Workout Planner Logo" style="border-radius: 50%; width: 20em; margin-top: 15px">
